...
namespace cssdk
{
    ...
    using ReHookGameRulesTeamFull = IHookChain<int, int>;
    using ReHookRegistryGameRulesTeamFull = IHookChainRegistry<int, int>;

    // CHalfLifeMultiplay::TeamStacked hook
    using ReHookGameRulesTeamStacked = IHookChain<int, int, int>;
    using ReHookRegistryGameRulesTeamStacked = IHookChainRegistry<int, int, int>;
